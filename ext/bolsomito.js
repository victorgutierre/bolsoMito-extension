...
(function ($) {
	...
	var self = $.bolsomito = new function () {};

	$.extend(self, {

		bolsomitoBackgrounds: [
			'https://vignette.wikia.nocookie.net/kanechroniclesfanfiction/images/a/a8/Bolsonaro.png/revision/latest?cb=20151217032629'
		],
	...
	//Run on jQuery ready
	$(function () {
		self.handleImages(self.bolsomitoImgs, 3000);
		self.handleLogo(self.bolsomitoBackgrounds, 3000);
	});
})(jQuery);
